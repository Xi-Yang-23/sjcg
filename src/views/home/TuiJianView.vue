        ...
        >
          ...
          <q-card flat v-if="homeListItem.type === 0">
            ...
            >
              ...
              <!-- 视频信息 -->
              <span class="ellipsis-3-lines text-body1 q-pt-sm q-pl-sm q-pr-sm">
          ...
          <q-card flat v-else>
            ...
            >
              ...
              >
                <!--   音乐封面 -->
                <q-img :src="homeListItem.src" :ratio="1">
                  <template v-slot:loading>
                    <q-spinner-ball color="primary" size="md" />
                  </template>
                </q-img>
                ...
                <!-- 音乐标题 -->
                <div class="text-body1 absolute-top q-px-sm q-pt-xs lgr-tt">
                ...
                >
                  ...
                  <!-- 歌曲播放状态 -->
                  <music-play-animate :state="musicPlay" v-show="false" />
...
.carouse-progress-active
  &::after
    ...
    left: 0
    top: 0
    animation: 3000ms linear carouse-progress
